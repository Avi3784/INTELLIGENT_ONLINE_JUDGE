module.exports = [
  {
    ...
    timeLimit: 2000,
    memoryLimit: 256,
    hints: ['A really brute force way would be to search for all possible pairs of numbers but that would be too slow. Again, it\'s best to try out brute force solutions for just for completeness. It is from these brute force solutions that you can come up with optimizations.', 'So, if we fix one of the numbers, say x, we have to scan the entire array to find the next number y which is value - x where value is the input parameter. Can we change our array keeping so that this search becomes faster?'],
    methodName: 'twoSum',
    defaultCode: {
  ...
  },
  {
    ...
    timeLimit: 2000,
    memoryLimit: 256,
    hints: ['Use a stack to keep track of open parentheses.'],
    methodName: 'isValid',
    defaultCode: {
      python: 'class Solution:\n    def isValid(self, s):\n        pass',
      javascript: 'class Solution {\n  isValid(s) {\n    \n  }\n}',
  ...
  },
  {
    ...
    timeLimit: 2000,
    memoryLimit: 256,
    hints: ['Calculate left products and right products.'],
  ...
  },
  {
    ...
    timeLimit: 2000,
    memoryLimit: 256,
    hints: ['Kadane\'s algorithm is optimal here.'],
  ...
  },
  {
    ...
    timeLimit: 2000,
    memoryLimit: 256,
    hints: ['Use the formula for sum of first n numbers.'],
  ...
  },
  {
    ...
    timeLimit: 2000,
    memoryLimit: 256,
    hints: ['Use two pointers, starting from both ends, moving the pointer at the shorter line inward.'],
    methodName: 'maxArea',
    defaultCode: {
  ...
  },
  {
    ...
    timeLimit: 2000,
    memoryLimit: 256,
    hints: ['Find the sorted half and binary search within.'],
    methodName: 'search',
    defaultCode: {
  ...
  },
  {
    ...
    timeLimit: 2000,
    memoryLimit: 256,
    hints: ['To reach step n, you can arrive from step n-1 or n-2.'],
  ...
  },
  {
    ...
    timeLimit: 2000,
    memoryLimit: 256,
    hints: ['Use memoization or bottom-up dynamic programming.'],
    methodName: 'fib',
    defaultCode: {
      python: 'class Solution:\n    def fib(self, n):\n        pass',
      javascript: 'class Solution {\n  fib(n) {\n    \n  }\n}',
